...
public class ApplyListener extends AbstractActionListener
{
    public ApplyListener(NCHomeConfigForm configFrom)
    {
        super(configFrom);
    }
    ...
    public void actionPerformed(ActionEvent actionEvent)
    {
        ...
        Messages.showInfoMessage("应用成功", "成功");
        ...
        String password = ((JPasswordField) configFrom.getComponent("passwordText", JPasswordField.class)).getText();
        // String password = ((JPasswordField) configFrom.getComponent("passwordText",
        // (Class)JTextField.class)).getText();
