 ...
 * @version 1.0<br>
 */
public class OpenPropAction extends AnAction
{
    public void actionPerformed(AnActionEvent e)
    {
        try
        {
            ...
            {
                homePath = configVO.getHomePath() + File.separator + "ierp" + File.separator + "bin" + File.separator + "logger-config.properties";
                MyNotifier.notifyInfo(e.getProject(), "本城正在帮你打开数据源配置文件：" + homePath);
                // MDEConsoleFactory.console("本城正在帮你打开NChome："+ homePath );
