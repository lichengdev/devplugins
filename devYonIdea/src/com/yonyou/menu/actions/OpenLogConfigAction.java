 ...
 * @version 1.0<br>
 */
public class OpenLogConfigAction extends AnAction
{
    public void actionPerformed(AnActionEvent e)
    {
        try
        {
            ...
            {
                homePath = configVO.getHomePath() + File.separator + "ierp" + File.separator + "bin" + File.separator + "prop.xml";
                MyNotifier.notifyInfo(e.getProject(), "本城正在帮你打开日志配置文件：" + homePath);
